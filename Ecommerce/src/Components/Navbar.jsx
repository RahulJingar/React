  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between h-16 items-center">
      ...
      <div className="flex items-center space-x-6">
        <a href="Login" className="text-gray-700 hover:text-indigo-600 font-medium text-sm hidden md:inline">Login </a>
    ...
    <div className="hidden md:flex justify-center space-x-8 py-2 border-t border-gray-200 text-sm text-gray-700">
          <Link to="/Mobiles" className="hover:text-indigo-600">Mobiles</Link>
          <Link to="/laptops" className="hover:text-indigo-600">Laptops</Link>
          <Link to="/tvs" className="hover:text-indigo-600">TVs</Link>
          <Link to="/appliances" className="hover:text-indigo-600">Appliances</Link>
          <Link to="/accessories" className="hover:text-indigo-600">Accessories</Link>
