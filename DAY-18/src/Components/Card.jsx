...
const Card = () => {
  return (
      ...
      <div >
       <h1 className='font-bolt text-2xl'>New Card</h1>
  <div className="max-w-xs bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 mx-auto">
